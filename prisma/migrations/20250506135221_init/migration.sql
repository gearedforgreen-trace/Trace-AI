...
-- CreateEnum
CREATE TYPE "bin_status" AS ENUM ('ACTIVE', 'INACTIVE');
...
-- AddForeignKey
ALTER TABLE "material" ADD CONSTRAINT "material_rewardRuleId_fkey" FOREIGN KEY ("rewardRuleId") REFERENCES "reward_rules"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "bin" ADD CONSTRAINT "bin_materialId_fkey" FOREIGN KEY ("materialId") REFERENCES "material"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
