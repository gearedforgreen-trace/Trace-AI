            ...
            <CardContent className="space-y-4">
              <div className="space-y-3">
                <div className="flex items-center gap-3 rounded-lg bg-white/80 p-3 dark:bg-muted/80">
                  ...
                  <span className="text-sm text-gray-700 dark:text-gray-300">Scan QR codes on recycling bins</span>
                </div>
                <div className="flex items-center gap-3 rounded-lg bg-white/80 p-3 dark:bg-muted/80">
                  <div className="flex h-8 w-8 items-center justify-center rounded-full bg-green-100 dark:bg-green-900/30">
                    <span className="text-sm font-bold text-green-600 dark:text-green-400">2</span>
                  </div>
                  <span className="text-sm text-gray-700 dark:text-gray-300">Earn points for recycling</span>
                </div>
                <div className="flex items-center gap-3 rounded-lg bg-white/80 p-3 dark:bg-muted/80">
                  <div className="flex h-8 w-8 items-center justify-center rounded-full bg-green-100 dark:bg-green-900/30">
                    <span className="text-sm font-bold text-green-600 dark:text-green-400">3</span>
                  </div>
                  <span className="text-sm text-gray-700 dark:text-gray-300">Redeem rewards and coupons</span>
                </div>
              </div>
